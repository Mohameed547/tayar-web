                ...
                <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center relative z-10">
                    ...
                    <div>
                        ...
                        <p className="mt-6 text-lg text-gray-400 max-w-lg leading-relaxed">
                            There are no delivery boundaries for us. Connect
                            customers, offices and delivery captains through one
                            powerful platform with live tracking and smart
                            management.
                        </p>

                        <div className="flex flex-wrap gap-4 mt-10">
                            <button className="flex items-center gap-2 px-7 py-4 rounded-xl bg-blue-600 hover:bg-blue-500 transition font-medium">
                                Make An Order
                            ...
                            <button className="px-7 py-4 rounded-xl border border-slate-700 hover:border-blue-500 hover:text-blue-400 transition">
                                Explore Features
                            </button>
                        </div>
                    </div>
            ...
            <section className="px-6 py-14">
                <div className="max-w-7xl mx-auto">
                    ...
                    <p className="text-gray-400 mt-4 max-w-lg">
                        Simple, fast, and transparent — from posting your
                        shipment to delivery confirmation.
                    </p>
                    ...
                    <div className="grid md:grid-cols-3 mt-10 divide-y md:divide-y-0 md:divide-x divide-slate-800">
                        {[
                            ...
                            <div
                                key={i}
                                className="relative p-8 pt-6 overflow-hidden"
                            >
                ...
                <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 leading-relaxed mb-10">
                            We built DeliveryHub because delivery in Egypt was
                            broken — fixed prices, no transparency, no tracking.
                            Now, customers get competitive offers, captains get
                            steady work, and offices grow without extra costs.
                        </p>
            ...
            <section className="px-6 py-14">
                <div className="max-w-5xl mx-auto text-center rounded-3xl border border-slate-800 bg-slate-900 p-12">
                    ...
                    <p className="mt-6 text-gray-400">
                        Join DeliveryHub and manage deliveries smarter, faster
                        and more efficiently.
                    </p>
                    <button className="mt-8 px-8 py-4 rounded-xl bg-blue-600 hover:bg-blue-500 transition">
                        Get Started Today
                    </button>
                </div>
            </section>

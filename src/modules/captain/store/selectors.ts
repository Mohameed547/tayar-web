...
export const selectVerification = (state: RootState) =>
  state.captainData.verification;
export const selectProfile = (state: RootState) => state.captainData.profile;
export const selectCaptainDataStatus = (state: RootState) =>
  state.captainData.status;
export const selectCaptainDataError = (state: RootState) =>
  state.captainData.error;
